...
void LCD1602_Init(void) {
    ...
    gpio_set_pin_mode(LCD1602_E_Port, LCD1602_E_Pin, OUTPUT);   // E
	gpio_set_pin_mode(LCD1602_RS_Port, LCD1602_RS_Pin, OUTPUT);	// RS
	gpio_set_pin_mode(LCD1602_D4_Port, LCD1602_D4_Pin, OUTPUT);	// D4
	gpio_set_pin_speed(LCD1602_D4_Port, LCD1602_D4_Pin, HIGH_SPEED);
	gpio_set_pin_mode(LCD1602_D5_Port, LCD1602_D5_Pin, OUTPUT);	// D5
	gpio_set_pin_speed(LCD1602_D5_Port, LCD1602_D5_Pin, HIGH_SPEED);
	gpio_set_pin_mode(LCD1602_D6_Port, LCD1602_D6_Pin, OUTPUT);	// D6
	gpio_set_pin_speed(LCD1602_D6_Port, LCD1602_D6_Pin, HIGH_SPEED);
	gpio_set_pin_mode(LCD1602_D7_Port, LCD1602_D7_Pin, OUTPUT);	// D7
	gpio_set_pin_speed(LCD1602_D7_Port, LCD1602_D7_Pin, HIGH_SPEED);
